...
- [Extension methods](General/Extensions.md) - How to extend existing classes in your packages ![Review](https://img.shields.io/badge/Progress-Review-blue.svg?style=flat)
