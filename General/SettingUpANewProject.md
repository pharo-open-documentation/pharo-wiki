...
![](img/SettingUp_DownloadPharo.png)
...
![](img/SettingUp_PharoLauncher.png)
...
![System Browser tool for developing projects in Pharo](img/SettingUp_SystemBrowser.png)
...
![Pharo System Browser, new package creation pop-up menu](img/SettingUp_NewPackage.png)
...
![Pharo System Browser, new class created](img/SettingUp_AddingClass.png)
...
![Pharo System Browser, new Test class created](img/SettingUp_TestClass.png)
...
![Pharo System Browser, new protocol creation pop-up menu](img/SettingUp_NewProtocol.png)
...
![Pharo System Browser, new variable added to class](img/SettingUp_AddingVariable.png)
...
![Repositories menu GitHub](img/SettingUp_NewRepoGit.png)
...
![GitHub, new repository creation form](img/SettingUp_CreateNewRepo.png)
