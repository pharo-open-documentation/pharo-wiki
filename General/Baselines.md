...
This class should be in a package separated from other package's projects. By convention, we name this package holding the baseline with the same name as the baseline. To summarize, `BaselineOfMyProject` class is in `BaselineOfMyProject` package.
