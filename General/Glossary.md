...
In the case of Pharo, [images](#image) are bootstrapped from the sources by the [continuous integration server](https://ci.inria.fr/pharo-ci-jenkins2/job/Test%20pending%20pull%20request%20and%20branch%20Pipeline/) each time a pull-request is merged on [pharo repository](https://github.com/pharo-project/pharo).
